...
import static com.mycompany.mavenproject1.utils.Utils.*;

import com.mycompany.mavenproject1.utils.CloseableIterator;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		SparkConf conf = new SparkConf().setAppName("mavenproject1");
